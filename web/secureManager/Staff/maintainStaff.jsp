...
<%
    List<Staff> productSelected = (List) session.getAttribute("staffSelected");
%>
...
<html>
    <head>
        ...
        <title><%= productSelected.get(0).getStaffName()%> | EZIFIT</title>        
        <style>
            body{
    ...
    <body>
        ...
        <table>
            ...
            <form action="SearchStaff.jsp" class="size">
                <div class="sizeTitle"></div>                    
                <h1><%= productSelected.get(0).getStaffName()%></h1>
                <input type="hidden" name="staff_id" value="<%= productSelected.get(0).getStaffId()%>">
