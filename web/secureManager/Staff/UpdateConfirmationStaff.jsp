        ...
        <div class="login-body">
            <div class="login-form">
                <form  action="../../UpdateStaff" >
                    <div class="login-title">Update Staff</div>
                    
                    <label>Staff ID</label>    
                    <input type="text" name="staff_id" placeholder="Username"  value="<%=staff.getStaffId()%>"required readonly/>
                    
                    <label>Staff Name</label>
                    <input type="text" name="staff_name" placeholder="Username" value="<%=staff.getStaffName()%>" required="required" />
                    
                    <label>Staff Email</label>
                    <input type="email" name="staff_email" placeholder="Email"  value="<%=staff.getStaffEmail()%>" required="required" />

                    <label>Staff Password</label>
                    <input type="password" id="password" name="password" placeholder="Password" value="<%=staff.getPassword()%>" required="required" />
