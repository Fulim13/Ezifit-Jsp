...
<!DOCTYPE html>
        <title>Update Product | EZIFIT</title>
<html>
    <head>
    ...
    <body>
        ...
        <div class="col-2">
            ...
            <h1 style="color: #8B0000">UPDATE PRODUCT</h1>
            ...
            <tr>
                ...
                <td class="customerReview">
                    <form action="../../UpdateProduct" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-box">
                            <label class="details">New Product Picture</label>
                            <input type="file" class="form-control" name="prod_picture" />    
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" class="form-control" name="prod_name" value="<%=product.getProdName()%>" />    
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" class="form-control" name="quantity"
                                   value="<%=String.format("%d", product.getQuantity())%>" />    
                        </div>

                        <div class="input-box">
                            <label class="details">Weight</label>
                            <input type="text" class="form-control" name="weight"
                                   value="<%=String.format("%.2f", product.getWeight())%>" />    
                        </div>
                       ...
                       value="<%=String.format("%.2f", product.getCost())%>" />    
                        </div>
