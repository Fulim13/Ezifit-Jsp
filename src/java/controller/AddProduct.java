...
public class AddProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Part profilePicture = request.getPart("image");
            ...
            Product product = new Product( prodName, description, price, quantity, weight, status.toUpperCase(), cost, size.toUpperCase(), category);//delete update view add
