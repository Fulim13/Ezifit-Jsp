...
public class AddComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            Review review = new Review(reviewID, rating, comment, replyComment, new Staff(staffID));
            
            utx.begin();
            boolean success = cartItemService.replyComment(review);
            utx.commit();
            
//            session.setAttribute("successComment", success);
