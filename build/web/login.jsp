        ...
        <div class="login-body">
            <div class="login-form">
                <form action="CheckLogin" method="POST" >
                    ...
                    <a href="forgotPassword.jsp" class="forgotpasswordlink">Forgot Password?</a>

                    <div class="error">${error.emailPasswordNotMatch ? "Email and Password Not Match" : ""}</div>
            ...
            <img height="542.6" src="people1.png" />
